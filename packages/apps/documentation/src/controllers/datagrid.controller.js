...
import data from '../data/datagrid/index.data.json';
import servers from '../data/datagrid/servers.data.json';
import metaData from '../data/datagrid/meta.data.json';
...
export default class {
  ...
  loadPartialData({
    ...
    const sortedData = sort.property
      ? this.orderBy(filteredData, sort.property, sort.dir === -1)
      : data;
