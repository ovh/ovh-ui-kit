import { getAttribute, hasAttributeValue } from '@ovh-ux/ui-kit.core/src/js/component-utils';
...
export default class FieldController {
  ...
  isErrorVisible() {
    ...
    this.checkAllErrors();
    return this.invalid
      && (this.form[this.currentErrorField].$modelValue || this.blurred || this.form.$submitted);
  }
