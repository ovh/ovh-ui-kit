...
const choicesTpl = require('./templates/choices.html');
const headerTpl = require('./templates/header.html');
const footerTpl = require('./templates/footer.html');
const matchTpl = require('./templates/match.html');
const matchMultipleTpl = require('./templates/match-multiple.html');
const noChoiceTpl = require('./templates/no-choice.html');
const selectTpl = require('./templates/select.html');
const selectMultipleTpl = require('./templates/select-multiple.html');
