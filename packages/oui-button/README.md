...
| --------------------- | ------- | ---------------------------------------------- |
| __@oui-font-color__   | Color   | `@oui-button-font-color: @oui-color-zodiac`    |
| __@oui-font-size__    | Number  | `@oui-button-font-size: rem-calc(16)`          |
| __@oui-font-weight__  | Keyword | `@oui-button-font-weight: @oui-font-semibold`  |
...
#oui > .button-filled(
  ...
  @oui-font-color_disabled,
  @box-shadow-color_active,
  @padding
);
```
| Parameter                       | Type   | Default Value                                                    |
